...
<template>
  <view class="container">
    ...
    <view class="card">
      ...
      <view class="row">
        <view class="row_cont"><text>当前参考盈亏：</text><text style="color:#E8473A">+ ¥ 5,320.00 (+5.33%)</text></view>
      </view>
      <view class="row">
        <view class="row_cont" style="color:#999999; font-size:12px;">参考数据更新时间：2025-11-15 14:30</view>
      </view>
      <view class="row">
        <view class="row_cont" style="color:#999999; font-size:12px;">参考盈亏 = 当前预估期权价值 - 总计支出，仅供参考，不作为最终结算依据。</view>
      </view>
      <view class="row"><view class="row_cont"><text>标的现价：</text>¥ 21.35</view></view>
      <view class="row"><view class="row_cont"><text>行权价：</text>¥ 20.20</view></view>
      <view class="row"><view class="row_cont"><text>距行权价：</text>+5.68%</view></view>
      <view class="row"><view class="row_cont"><text>剩余到期：</text>12 天</view></view>
      ...
      <view class="row"><view class="row_cont"><text>行权/了结截止时间：</text>2025-12-02 15:00</view></view>
    ...
    <view class="card">
      ...
      <view class="row"><view class="row_cont"><text>下单时间：</text>2025-11-01 14:55</view></view>
